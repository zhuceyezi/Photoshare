...
CREATE TABLE Users ( -- capitalized entitys for notations
    ...
    dob DATE,           -- date of birth is not necessary for sign up
    hometown VARCHAR(20),
    gender VARCHAR(20),
    password VARCHAR(255) NOT NULL, -- password is not null
...
-- sql for u may also like: temp is common friend. if they already be friend, delete that result.
